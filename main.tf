...
resource "aws_ecs_service" "retool" {
  ...
  desired_count                      = var.ecs_task_resource_map["main"]["desired_count"]
...
resource "aws_ecs_service" "jobs_runner" {
  ...
  cluster         = aws_ecs_cluster.this.id
  desired_count   = var.ecs_task_resource_map["jobs_runner"]["desired_count"]
...
resource "aws_ecs_service" "workflows_backend" {
  ...
  cluster         = aws_ecs_cluster.this.id
  desired_count   = var.ecs_task_resource_map["workflows_backend"]["desired_count"]
...
resource "aws_ecs_service" "workflows_worker" {
  ...
  cluster         = aws_ecs_cluster.this.id
  desired_count   = var.ecs_task_resource_map["workflows_worker"]["desired_count"]
